        ...
        <>
            ...
            <div className="bodyContainerTP">
                ...
                <div className="Tpsec">
                    ...
                    <div>
                        <h2>Privacy Policy for E-COMM</h2>
                        <p>
                            At E-COMM, accessible at E-COMM.com, one of our main priorities is the privacy of our
                            visitors. This Privacy Policy document contains types of information that is collected and
                            recorded by E-COMM.com and how we use it.
                        </p>
                        <p>
                            If you have additional questions or require more information about our Privacy Policy, do not
                            hesitate to contact us through email at Email@E-COMM.com
                        </p>
                        <p>
                            This privacy policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in E-COMM. This
                    ...
                    <div>
                        <h2>Log Files</h2>
                        <p>
                            E-COMM follows a standard procedure of using log files. These files log visitors when they
                    ...
                    <div>
                        ...
                        <p>
                            Like any other website, E_COMM uses ‘cookies'. These cookies are used to store information
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            that are used in their respective advertisements and links that appear on E_COMM, which
                        ...
                        <p>
                            Note that E-COMM has no access to or control over these cookies that are used by third-party
                            advertisers.
                        </p>
                    </div>
                    <hr className="bodyHrTP" />
                    ...
                    <div>
                        ...
                        <p>
                            E-COMM's Privacy Policy does not apply to other advertisers or websites. Thus, we are
